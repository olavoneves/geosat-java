#!/bin/bash
# ============================================================
#  GEOSAT — Script de Validacao
#  Verifica se todos os recursos foram criados corretamente
#
#  EXECUTAR COM:
#  bash /c/Users/StartSe/entregáveis/globalsolution/devops/geosat-devops-final/scripts-cli/validate-geosat.sh
# ============================================================
...
echo ""
echo "============================================="
echo "  GEOSAT - VALIDACAO DA INFRAESTRUTURA"
echo "============================================="
echo ""
